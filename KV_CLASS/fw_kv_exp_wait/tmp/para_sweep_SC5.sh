...
# ==============================
# 小さい → 大きい で 4段階ずつ
LAMBDA_LIST=${LAMBDA_LIST:-"0.95 0.85 0.50 0.70"}
ETA_LIST=${ETA_LIST:-"0.70 0.50 0.30 0.10"}

SEEDS=${SEEDS:-"0"}
S_LIST=${S_LIST:-"5"}      # 固定でOK。変更したい場合はここ
...
# 出力設定
# ==========================================
OUT_DIR=${OUT_DIR:-"results_SC5_lambda_eta_sweep"}
