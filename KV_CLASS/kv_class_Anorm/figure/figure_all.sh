...
#############################################
# 6. S-loop ratio 可視化（sloop_ratio_all.py）
#############################################
echo "==============================================="
echo "[STEP 6] Plot S-loop ratio summary (sloop_ratio_all.py)"
echo "==============================================="

python3 sloop_ratio_all.py
...
#############################################
# 7. Ba-FW cos heatmap 可視化（h_heatmap_bafw_two.py）
#############################################
echo "==============================================="
echo "[STEP 7] Plot Ba-FW cosine heatmaps (h_heatmap_bafw_two.py)"
echo "==============================================="

python3 h_heatmap_bafw_two.py
...
#############################################
# Plot: cos(h0, Ah0) over time
#############################################
echo "==============================================="
echo "[STEP 8] Plot cos(h0, Ah0) over time (plot_cos_h0_Ah0_over_time.py)"
echo "==============================================="

python3 plot_cos_h0_Ah0_over_time.py
...
#############################################
# Check: prototypes / sanity checks
#############################################
echo "==============================================="
echo "[STEP 9] Check prototypes (check_prototypes.py)"
echo "==============================================="
